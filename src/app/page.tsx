          ...
          <Button
            onClick={async () => {
              ...
              try {
                ...
                // Client-side PDF generation using print window
...
function ChercheurSection() {
  ...
  const handleGetInsights = async (type: string) => {
    setInsightsLoading(true);
    try {
      const res = await fetch('/api/insights', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({ context: 'chercheur', type }),
      });
      const data = await res.json();
      ...
      // Fallback insights
      setInsights([
        '💡 Continuez votre pratique régulière. La constance est la clé de la transformation.',
        '📊 Tenez votre journal de pratique quotidien pour suivre votre progression.',
        '🤝 Partagez vos découvertes avec la communauté de praticiens.',
      ]);
    } finally {
